...
export function applyManagementRoutes(parentRouter: Router) {
    ...
    managementRouter.put(
        ...
        body('date').isISO8601(),
        body('reviewParameters.startDate').isISO8601(),
        body('reviewParameters.endDate').isISO8601(),
    ...
    managementRouter.delete(
        '/answer-sheets/:answerSheetId/:fileId',
        param('answerSheetId').isMongoId(),
